...
namespace ORB_SLAM3
{
    ...
    public:
        ...
        int SearchForSuperInitialization(Frame &F1, Frame &F2, std::vector<cv::Point2f> &vbPrevMatched, std::vector<int> &vnMatches12, int windowSize=10);
        int SearchBySuperBoW(KeyFrame* pKF,Frame &F, vector<MapPoint*> &vpMapPointMatches);
