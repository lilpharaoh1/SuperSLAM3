...
KeyFrame::KeyFrame():
        ...
        matches_prev(static_cast<vector<int> >(NULL)), matches_curr(static_cast<vector<int> >(NULL)),
...
KeyFrame::KeyFrame(Frame &F, Map *pMap, KeyFrameDatabase *pKFDB):
    ...
    mbf(F.mbf), mb(F.mb), mThDepth(F.mThDepth), N(F.N), mvKeys(F.mvKeys), mvKeysUn(F.mvKeysUn), matches_prev(F.matches_prev), matches_curr(F.matches_curr),
