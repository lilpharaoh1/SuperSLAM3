...
namespace ORB_SLAM3
{
    ...
    int ORBmatcher::SearchForSuperInitialization(Frame &F1, Frame &F2, vector<cv::Point2f> &vbPrevMatched, vector<int> &vnMatches12, int windowSize)
    {
        int nmatches=0;        
        //Update prev matched
        for(size_t i1=0, iend1=vnMatches12.size(); i1<iend1; i1++)
        ...
        // TODO : DO THIS BETTER ( could be one loop )
